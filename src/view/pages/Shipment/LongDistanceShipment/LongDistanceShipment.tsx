...
// Listing Table
import LongDistanceShipmentListing from "./LongDistanceShipmentListing/LongDistanceShipmentListing";
// Create Modal
import LongDistanceShipmentCreate from "./LongDistanceShipmentCreate/LongDistanceShipmentCreate";
// Delete Modal
import LongDistanceShipmentDelete from "./LongDistanceShipmentDelete/LongDistanceShipmentDelete";
// Search Form
...
const LongDistanceShipment = () =>{
    ...
    <>
        <Box sx={(theme)=>({ 
            ...
            <LongDistanceShipmentListing/>
        </Box>
       { isCreateModal &&
        <LongDistanceShipmentCreate isCreateModal={isCreateModal} setIsCreateModal={setIsCreateModal} />
       }
       { isDeleteModal &&
        <LongDistanceShipmentDelete isOpen={isDeleteModal} setIsOpen={setIsDeleteModal} />
       }
       { isCalendarModal && 
...
export default LongDistanceShipment
