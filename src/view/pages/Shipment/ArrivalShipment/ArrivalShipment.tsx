...
// Listing Table
import ArrivalShipmentListing from "./ArrivalShipmentListing/ArrivalShipmentListing";
// Create Modal
import ArrivalShipmentCreate from "./ArrivalShipmentCreate/ArrivalShipmentCreate";
// Delete Modal
import ArrivalShipmentDelete from "./ArrivalShipmentDelete/ArrivalShipmentDelete";
// Search Form
...
const ArrivalShipment = () =>{
    ...
    <>
        <Box sx={(theme)=>({ 
            ...
            <ArrivalShipmentListing/>
        </Box>
       { isCreateModal &&
        <ArrivalShipmentCreate isCreateModal={isCreateModal} setIsCreateModal={setIsCreateModal} />
       }
       { isDeleteModal &&
        <ArrivalShipmentDelete isOpen={isDeleteModal} setIsOpen={setIsDeleteModal} />
       }
       { isCalendarModal && 
...
export default ArrivalShipment
