...
// Listing Table
import UnassignedShipmentListing from "./UnassignedShipmentListing/UnassignedShipmentListing";
// Create Modal
import UnassignedShipmentCreate from "./UnassignedShipmentCreate/UnassignedShipmentCreate";
// Delete Modal
import UnassignedShipmentDelete from "./UnassignedShipmentDelete/UnassignedShipmentDelete";
// Search Form
...
const UnassignedShipment = () =>{
    ...
    <>
        <Box sx={(theme)=>({ 
            ...
            <UnassignedShipmentListing/>
        </Box>
       { isCreateModal &&
        <UnassignedShipmentCreate isCreateModal={isCreateModal} setIsCreateModal={setIsCreateModal} />
       }
       { isDeleteModal &&
        <UnassignedShipmentDelete isOpen={isDeleteModal} setIsOpen={setIsDeleteModal} />
       }
       { isCalendarModal && 
...
export default UnassignedShipment
