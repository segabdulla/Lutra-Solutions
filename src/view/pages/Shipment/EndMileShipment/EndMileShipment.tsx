...
// Listing Table
import EndMileShipmentListing from "./EndMileShipmentListing/EndMileShipmentListing";
// Delete Modal
import EndMileShipmentDelete from "./EndMileShipmentDelete/EndMileShipmentDelete";
// Search Form
...
const EndMileShipment = () =>{
    ...
    <>
        <Box sx={(theme)=>({ 
            ...
            <EndMileShipmentListing/>
        </Box>
    
       { isDeleteModal &&
        <EndMileShipmentDelete isOpen={isDeleteModal} setIsOpen={setIsDeleteModal} />
       }
       { isCalendarModal && 
...
export default EndMileShipment
