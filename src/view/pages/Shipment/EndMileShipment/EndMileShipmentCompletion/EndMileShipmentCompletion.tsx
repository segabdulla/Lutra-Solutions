...
import PlaceholderThumb from "../../../../../assets/images/contentPlaceholder.png";
...
const EndMileShipmentCompletion:FC<Props> = ({
  formValue,
  isCompletionModal,
        ...
        <Tabs defaultValue="Details">
          ...
          {/* <Tabs.Panel value="Completion report">
            <Box style={{
              ...
              <Image style={{height: 210, width: 275}} src={PlaceholderThumb} alt="" />
              <Title 
              sx={(theme)=>({
                  fontWeight: 900,
                  marginBottom: 20,
...
export default EndMileShipmentCompletion;
