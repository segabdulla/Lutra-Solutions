...
// Listing Table
import DriverListing from "./DriverListing/DriverListing";
// Search Form
...
const Driver = () =>{
    ...
    <>
       ...
       { isCreateModal &&
        <DriverCreate isCreateModal={isCreateModal} setIsCreateModal={setIsCreateModal} />
       }
       { isDeleteModal &&
        <DriverDelete isOpen={isDeleteModal} setIsOpen={setIsDeleteModal} />
       }
    </>
)}
